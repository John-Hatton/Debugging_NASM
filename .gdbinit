...
#
#
#		*** Note from John **** 09/30/2022
#
#
#	The YouTube video I was watcing the other night made use of a file that saved the		
#	 settings previously entered by the user. I went through the rough basic steps of 
#	 geting GDB to print useful information. I was able to find such a script, and  
#	 from the looks of it, it seems to be an extremely useful script. 
#
#
#	Note of warning...		
#	There are 3000 lines of code in this GDB init file. I have reviewed some of it, but
#	 mainly hold onto the hope that a file at https://github.com/gdbinit/Gdbinit/ should
#	 be relatively safe. Or we're all getting duped. This repo has 457 forks! Lol
#
###############################################################################################
#
#
